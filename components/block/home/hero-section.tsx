...
export function HeroSection() {
  return (
    <section className="relative isolate w-screen ml-[calc(50%-50vw)] overflow-hidden px-6 md:px-12 pt-32 md:pt-40 pb-12 md:pb-16">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-0 h-[26rem] bg-[radial-gradient(70%_80%_at_50%_0%,rgba(252,163,17,0.14),transparent_70%)]"
      />
      <div
        aria-hidden="true"
        className="absolute -top-44 left-1/2 -translate-x-1/2 h-96 w-[46rem] rounded-full bg-brand/15 blur-[130px]"
      />
      <div
        aria-hidden="true"
